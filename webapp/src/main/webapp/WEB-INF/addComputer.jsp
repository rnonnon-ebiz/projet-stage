...
<spring:message code="placeholder.date" var="placeholderDate"/>
	...
	<form:form class="form-horizontal " id="addComputerForm"
		...
		<div
			...
			<label class="col-sm-2 control-label" for="discontinued"><spring:message code="label.discontinued"/></label>
			<div class="col-sm-10">
				<div class="col-xs-2">
					<form:input class="form-control datepicker"
			...
			<div class="col-sm-offset-2 col-sm-10">
				<div class="col-xs-2">
					<button type="submit" class="btn btn-success">
						<span class="glyphicon glyphicon-ok"></span><spring:message code="button.add"/>
					</button>
